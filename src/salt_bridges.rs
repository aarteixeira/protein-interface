...
//!
//! A salt bridge is counted when an anionic side-chain oxygen and a cationic
//! side-chain nitrogen on opposite sides of the interface lie within `cutoff`
//! Å (Barlow & Thornton 1983 use 4.0 Å between charged centres).
...
fn is_cation(residue: &str, atom: &str) -> bool {
    matches!(
        (residue, atom),
        ("LYS", "NZ") | ("ARG", "NE") | ("ARG", "NH1") | ("ARG", "NH2") | ("HIS", "ND1") | ("HIS", "NE2")
    )
}
